...
duck_cursor.execute("CREATE TABLE IF NOT EXISTS presentations(presentation_date Date NOT NULL UNIQUE, author String NOT NULL, title String NOT NULL, bio String, abtract string, zoom_link String);")
